...
export default function EditAddress(
  ...
  const [update, setUpdate] = useState(props.currentAddres)
  return (
    <StyledAddressForm
      onSubmit={(form) => {
        form.preventDefault()
    ...
    >
      <label htmlFor="location">
        ...
        <input
          type="text"
          name="location"
          placeholder={props.currentAddres.location}
          defaultValue={props.currentAddres.location}
          onChange={(v) => {
      ...
      <label htmlFor="name">
        ...
        <input
          type="text"
          name="name"
          placeholder={props.currentAddres.name}
          defaultValue={props.currentAddres.name}
          onChange={(v) => {
      ...
      <label htmlFor="mobile">
        ...
        <input
          ...
          name="mobile"
          placeholder="mobile"
          defaultValue={props.currentAddres.mobile}
          onChange={(v) => {
      ...
      <label htmlFor="pin">
        ...
        <input
          ...
          placeholder="pin"
          required
          defaultValue={props.currentAddres.pin}
          onChange={(v) => {
      ...
      <label htmlFor="city">
        ...
        <input
          ...
          placeholder="city"
          required
          defaultValue={props.currentAddres.city}
          onChange={(v) => {
