              ...
              >
                <label htmlFor="location">
                  ...
                  <input
                    ...
                    onChange={(v) => {
                      return { console.log(update){ ...update, location: v.target.value }}
                    }}
                    required
                  />
                </label>
                <label htmlFor="name">
                  ...
                  <input
                    ...
                    onChange={(v) => {
                      return { ...update, name: v.target.value }
                    }}
                    required
                  />
                </label>
                <label htmlFor="mobile">
                  ...
                  <input
                    ...
                    onChange={(v) => {
                      return { ...update, mobile: v.target.value }
                    }}
                    required
                  />
                </label>
                <label htmlFor="pin">
                  ...
                  <input
                    ...
                    onChange={(v) => {
                      return { ...update, pin: v.target.value }
                    }}
                  />
                </label>
                <label htmlFor="city">
                  ...
                  <input
                    ...
                    onChange={(v) => {
                      return { ...update, city: v.target.value }
                    }}
                  />
                </label>
