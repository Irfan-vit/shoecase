      ...
      <label htmlFor="location">
        ...
        <input
          ...
          onChange={(v) => {
            ...
            return (e.location = v.target.value)
          }}
          required
        />
      </label>
