              ...
              >
                ...
                <label htmlFor="name">
                  ...
                  <input
                    ...
                    onChange={(v) => {
                      return setU{ ...update, name: v.target.value }
                    }}
                    required
                  />
                </label>
                <label htmlFor="mobile">
                  ...
                  <input
                    ...
                    onChange={(v) => {
                      return setU{ ...update, mobile: v.target.value }
                    }}
                    required
                  />
                </label>
                <label htmlFor="pin">
                  ...
                  <input
                    ...
                    onChange={(v) => {
                      return setU{ ...update, pin: v.target.value }
                    }}
                  />
                </label>
                <label htmlFor="city">
                  ...
                  <input
                    ...
                    onChange={(v) => {
                      return setU{ ...update, city: v.target.value }
                    }}
                  />
                </label>
