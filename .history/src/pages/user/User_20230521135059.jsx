        ...
        {userDetails.address.map((e) => (
          <StyledAddress key={e.id}>
            {toggleEdit.state === true && toggleEdit.id === e.id ? (
              EditAddress(setUpdate, update, setUserDetails, userDetails, toggleEdit, e, setToggleEdit)
            ) : (
              <div>
                <h4>{e.name}</h4>
                <p>{e.mobile}</p>
...
export default User
function EditAddress(setUpdate, update, setUserDetails, userDetails, toggleEdit, e, setToggleEdit) {
