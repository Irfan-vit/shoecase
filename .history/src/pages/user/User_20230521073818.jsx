...
const User = () => {
  ...
  return (
    <>
      <div>{console.log(token, userDetails.address.name)}</div>
      <div>
        <h2>Address</h2>
        <p>{userDetails.address.name}</p>
        <p>{userDetails.address.mobile}</p>
        <p>{userDetails.address.pin}</p>
        <p>{userDetails.address.city}</p>
        <p>{userDetails.address.location}</p>
      </div>
      <button
        onClick={() => {
          localStorage.clear()
