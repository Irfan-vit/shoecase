...
const User = () => {
  ...
  return (
    <>
      ...
      <div>
        <h2>Address</h2>
        {userDetails.address.map(e => div)}
        <div>
          <p>{userDetails.address[0].name}</p>
          <p>{userDetails.address[0].mobile}</p>
          <p>{userDetails.address[0].pin}</p>
          <p>{userDetails.address[0].city}</p>
          <p>{userDetails.address[0].location}</p>
        </div>
        <div>
          <p>{userDetails.address[0].name}</p>
          <p>{userDetails.address[0].mobile}</p>
